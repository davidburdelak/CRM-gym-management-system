...
<body>
	...
	<nav class="navbar navbar-expand-md bg-dark navbar-dark">
		<div class="container-fluid">
			...
			<a href="logout.php" class=" nav nav-link" id="logout">LOGOUT</a>
		</div>
	</nav>
	<div class="row mt-3">
		<div class="col-2">
			<div id="accordion">
				<div class="list-group">
					<div class="list-group-item bg-dark">
						...
						<i class="fas fa-user-alt"></i> GYMS</a>
					</div>
					<div id="collapseTwo" class="collapse" data-parent="#accordion">
						<div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=add_gym" class="text-light">ADD GYM</a></div>
